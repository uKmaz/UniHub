...
public class ApplicationConfig {
    ...
    public UserDetailsService userDetailsService() {
        // Spring Security'e, kullanıcıları nasıl bulacağını söylüyoruz.
        // Bizim sistemimizde "username" olarak Firebase UID'yi kullanacağız.
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        // Şifre kontrolü yapmadığımız için bir şifre kodlayıcıya ihtiyacımız yok,
        // ama bean'in var olması gerekiyor.
