...
public class FeedController {
    ...
    public ResponseEntity<List<PostSummaryResponse>> getPostFeed(
        ...
        List<PostSummaryResponse> feed = feedService.getPostFeed(firebaseUid, page, size);
    ...
    public ResponseEntity<List<EventSummaryResponse>> getEventFeed(
        ...
        String firebaseUid = (String) authentication.getPrincipal();
        List<EventSummaryResponse> feed = feedService.getEventFeed(firebaseUid, page, size);
        return ResponseEntity.ok(feed);
    }
}