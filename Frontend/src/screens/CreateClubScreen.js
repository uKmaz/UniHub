...
const CreateClubScreen = ({ navigation }) => {
    ...
    const handleCreateClub = async () => {
        ...
        try {
            ...
            const errorMessage = error.response?.data?.message || t('clubCreateError');
    ...
    return (
        <SafeAreaView style={styles.container}>
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                ...
                <TextInput style={styles.input} placeholder={t('clubShortNamePlaceholder')} value={shortName} onChangeText={setShortName} />
