...
public class EventService {
    ...
    public EventDetailResponse createEventForClub(Long clubId, EventCreationRequest request, String creatorFirebaseUid) {
        ...
        clubMemberRepository.findByClubIdAndUserId(clubId, creator.getId())
                .filter(member -> member.getRole() == Role.OFFICER || member.getRole() == Role.ADMIN)
    ...
    // Note: You will need to add Optional<EventAttendee> findByUserAndEvent(User user, Event event); to EventAttendeeRepository
